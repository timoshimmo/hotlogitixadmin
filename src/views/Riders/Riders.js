...
//  const theme = useTheme();
  ...
  //  const handleUsersList = () => {
      if(!loading) {
        ...
        DB.collection("riders").get().then((querySnapshot) => {
          var arr = [];
          querySnapshot.forEach((doc) => {
              // doc.data() is never undefined for query doc snapshots
              arr.push({"id": doc.id, "fullname": doc.data().name, "mobileNo": doc.data().phoneNumber,
                "vehicle": doc.data().vehicle, "verified": doc.data().verified,
                "licenses": doc.data().licenses, "documentUrl": doc.data().documentUrl});
          });
          setLoading(false);
          setUsersList(arr);
    ...
    <div className={classes.root}>
      <div className={classes.body}>
          {loading ?
            ...
            :
            <RidersTable usersList={filteredUsers} handleFilter={handleFilter} />
          }
      </div>
